...
copy requirements.txt "C:\Program Files\Side Effects Software\Houdini 17.0.459\python27\requirements.txt"
:: [2] The program navigates to the houdini-python directory
cd C:\Program Files\Side Effects Software\Houdini 17.0.459\python27
